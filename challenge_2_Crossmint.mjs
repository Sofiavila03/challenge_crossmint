...
class PolyanetManager {
  ...
  async createPolyanet(x, y) {
    ...
    const candidateId = '57f26425-fa0e-48f4-bbce-8e4f58b427b9';
...
class ComethManager {
  ...
  async function getMatrix() {
    return await fetch('https://challenge.crossmint.io/api/map/57f26425-fa0e-48f4-bbce-8e4f58b427b9/goal')
      .then(response => {
        if (response.ok) {
